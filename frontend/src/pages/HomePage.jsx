  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (!transcription || transcription.trim() === '') {
        alert('Transcription returned empty.');
        return;
      }
      ...
      console.error('Error during summary generation:', err.response?.data || err.message);
      ...
      >
        ...
        >
          ...
          <Stack spacing={2} alignItems="center">
            ...
            >
              Select File
              <input type="file" accept=".mp3,.mp4" hidden onChange={handleFileChange} />
            </Button>
